<li class="dropdown">
	...
	<ul class="dropdown-menu">
		...
		<li class="divider"></li>
		<li><a href="<{'admin/logs'|url}>" name="logs/list"><i class="fa fa-edit fa-fw pull-right"></i> PHP日志</a></li>
		<li class="divider"></li>
		<{/if}>
		...
		<li><a href="<{'admin/auth/logout'|url}>"><span class="text-danger"><i class="gi gi-exit pull-right"></i> 退出系统</span></a></li>
	</ul>
</li>
