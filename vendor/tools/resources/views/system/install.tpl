...
<form class="form-horizontal" role="form" action="<{'install/save-query'|url}>" method="POST" id="form" confirm="您确认每一项都输入无误（系统不会深度检查输入的有效性）？">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="SESSION_PATH" name="SESSION_PATH" value="<{env('SESSION_PATH', $_path)}>" placeholder="如果根目录请输入：/">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="url" class="form-control" id="APP_URL" name="APP_URL" value="<{env('APP_URL', $_url)}>" placeholder="比如：http://127.0.0.1/">
			<span class="help-block">
