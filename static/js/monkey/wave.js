function SiriWave(opt){
	...
	(this.opt.container || document.getElementById("wave")).appendChild(this.canvas);
...
SiriWave.prototype = {
	...
	_draw: function(){
		...
		this._clear();
		this._drawLine(-2, 'rgba(119,194,205,0.1)');
		this._drawLine(-6, 'rgba(119,194,205,0.2)');
		this._drawLine(4, 'rgba(119,194,205,0.4)');
		this._drawLine(2, 'rgba(119,194,205,0.9)');
		this._drawLine(1, 'rgba(119,194,205,0.6)', 1.5);
